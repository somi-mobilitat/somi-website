        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-on-scroll">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:space-x-8 mb-8">
              ...
              <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 dark:text-white leading-snug mb-2 mt-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12 mt-8">
              <Button
                variant="outline"
                className="rounded-full px-8 py-6 border-gray-300 hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-800 button-hover-effect"
              >
